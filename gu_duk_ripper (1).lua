 local RadientPaid = {}
    ...
    function RadientPaid:Window(text,maincolor)
       ...
       UserImage.Image = "http://www.roblox.com/asset/?id=10731738718"
       ...
       UserName.Text = "DUNGEON MODE"
       UserTag.Text = "#" .. " Luxury ON TOP"
       ...
       function ServerHold:Server(text,textgame, img)
          ...
          function ChannelHold:Channel(text)
             ...
             function ChannelContent:Colorpicker(text, preset, callback)
                ...
                Color.BackgroundColor3 = Color3.fromRGB(255, 0, 99)
                ...
                HueGradient.Color = ColorSequence.new {
                   ColorSequenceKeypoint.new(0.00, Color3.fromRGB(255, 0, 99)),
                   ColorSequenceKeypoint.new(0.20, Color3.fromRGB(234, 255, 0)),
                   ColorSequenceKeypoint.new(0.40, Color3.fromRGB(21, 255, 0)),
                   ColorSequenceKeypoint.new(0.60, Color3.fromRGB(0, 255, 255)),
                   ColorSequenceKeypoint.new(0.80, Color3.fromRGB(0, 17, 255)),
                   ColorSequenceKeypoint.new(0.90, Color3.fromRGB(255, 0, 251)),
                   ColorSequenceKeypoint.new(1.00, Color3.fromRGB(255, 0, 99))
                }
       ...
       return ServerHold
        ...
        local win = RadientPaid:Window("Dungeon")
    
        local serv = win:Server("Luxury Hub", "10731738718")
    
        local RaidTab = serv:Channel("Main")
        local Settings = serv:Channel("Settings")
        
    RaidTab:Dropdown("Difficulty",{"Normal","Easy"},function(boolean)
        _G.Difficulty = boolean
    end)
    RaidTab:Toggle("Auto Raid",_G.Auto_Raid,function(boolean)
        _G.Auto_Raid = boolean
    end)
    
    _G.Set_HP = 50
    RaidTab:Slider("Set Health %",1,100, _G.Set_HP, function(bool)
        _G.Set_HP = bool
        
    end)
    RaidTab:Toggle("Safe Mode",_G.Safe_Mode,function(boolean)
        _G.Safe_Mode = boolean
        
    end)
    
    RaidTab:Label("Settings")
    local Weaponlist = {}
    ...
    local SelectWeapona = RaidTab:Dropdown("Select Melee",Weaponlist,function(Value)
            _G.SelectWeapon = Value
        end)
    
    RaidTab:Button("Refresh Weapon", function()
        SelectWeapona:Clear()
    ...
    local FFFFFFFFFFFF = RaidTab:Dropdown("Select Sword",Weaponlist,function(Value)
        _G.SelectWeapon2 = Value
    end
    )
    
    RaidTab:Button("Refresh Weapon 2", function()
        FFFFFFFFFFFF:Clear()
        for i,v in pairs(game.Players.LocalPlayer.Backpack:GetChildren()) do  
            if v:IsA("Tool") then
                FFFFFFFFFFFF:Add(v.Name)
            end
        end
        for i,v in pairs(game.Players.LocalPlayer.Character:GetChildren()) do  
            if v:IsA("Tool") then
    ...
    local EEEEEEEEEEEEEEEEEE = RaidTab:Dropdown("Select Fruits",Weaponlist,function(Value)
        _G.SelectWeapon3 = Value
    end
    )
    
    RaidTab:Button("Refresh Weapon 3", function()
        EEEEEEEEEEEEEEEEEE:Clear()
        for i,v in pairs(game.Players.LocalPlayer.Backpack:GetChildren()) do  
            if v:IsA("Tool") then
                EEEEEEEEEEEEEEEEEE:Add(v.Name)
            end
        end
        for i,v in pairs(game.Players.LocalPlayer.Character:GetChildren()) do  
            if v:IsA("Tool") then
    ...
    RaidTab:Toggle("Skill Z",_G.Skill_Z,function(boolean)
        _G.Skill_Z = boolean
        
    end)
    RaidTab:Toggle("Skill X",_G.Skill_X,function(boolean)
        _G.Skill_X = boolean
        
    end)
    RaidTab:Toggle("Skill C",_G.Skill_C,function(boolean)
        _G.Skill_C = boolean
        
    end)
    RaidTab:Toggle("Skill V",_G.Skill_V,function(boolean)
        _G.Skill_V = boolean
    end)
    
    _G.Auto_Haki = true
    Settings:Toggle("Auto Haki",_G.Auto_Haki,function(value)
        _G.Auto_Haki = value
    end)
    
    _G.Auto_Ken = true
    Settings:Toggle("Auto Ken",_G.Auto_Ken,function(value)
        _G.Auto_Ken = value
    end)
            ...
            if _G.Auto_Raid then
                pcall(function()
                    if game.PlaceId == 5931540094   then
                        game:GetService("ReplicatedStorage").ChooseMapRemote:FireServer(_G.Difficulty)
        ...
        pcall(function()
                if _G.Auto_Raid then
                    for i,v in pairs(game:GetService("Workspace").MOB:GetChildren()) do
                        ...
                        wait(2)
                        game.Players.LocalPlayer.Character.Humanoid:EquipTool(game.Players.LocalPlayer.Backpack:FindFirstChild(_G.SelectWeapon2))
                        wait(1.6)
                        game.Players.LocalPlayer.Character.Humanoid:EquipTool(game.Players.LocalPlayer.Backpack:FindFirstChild(_G.SelectWeapon3))
                        wait(1)
                    end
                end
            end)
    ...
    spawn(function()
        while true do
            if _G.Auto_Raid and game.PlaceId == 5931540094 and AttackOn then
               pcall(function()
                    for i,v in pairs(game:GetService("Workspace").MOB:GetChildren()) do
                        if v:FindFirstChild("HumanoidRootPart") then
                            Mob = v
                                repeat wait()
                                    spawn(function()
                                        plr.Character.HumanoidRootPart.CFrame = v.HumanoidRootPart.CFrame * CFrame.new(0,6,0) * CFrame.Angles(math.rad(-90),0,0)
                                    end)
                                    spawn(function()
                                    if  _G.Skill_Z then
                                        skilluse("Z")
                                ...
                                until  v.Humanoid.Health <= 0 or _G.Auto_Raid == false or not AttackOn 
                            return
                        end
                    end
               end) 
    ...
    spawn(function()
        while true do
            if _G.Safe_Mode then
                pcall(function()
                    if plr.Character.Humanoid.Health >= plr.Character.Humanoid.MaxHealth / 100 * _G.Set_HP  then
                        AttackOn = true
                    else
                        repeat
                            AttackOn = false
                            for i,v in pairs(game:GetService("Workspace").MOB:GetChildren()) do
                                if v:FindFirstChild("HumanoidRootPart") then
                                    ...
                                    until plr.Character.Humanoid.Health >= plr.Character.Humanoid.MaxHealth or v.Humanoid.Health <= 0 or _G.Auto_Raid == false 
                                    return
                                end
                            end
                            task.wait()
                        until plr.Character.Humanoid.Health >= plr.Character.Humanoid.MaxHealth or not _G.Safe_Mode
                    end
                end)
            end
            task.wait()
